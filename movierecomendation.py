...
Original file is located at
    https://colab.research.google.com/drive/18QSAg_ituRiVkEfVUFJGcOIYPoxjMUO0
"""
...
df_features = df[['Movie_Genre','Movie_Revenue','Movie_Tagline','Movie_Cast','Movie_Director']].fillna('')
